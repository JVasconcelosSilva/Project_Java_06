                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nomeEdit" maxlength="40" required value="<%=o.getNm_obra()%>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" maxlength="11" name="obra" value="<%=o.getObra()%>" >
                        </div>
                    </div>
                    <br>
                    <br>
                    <input type="submit" class="btn btn-primary" name="formEditObra" value="Editar">
                    <input type="submit" class="btn btn-primary" name="formEditUser" value="Excluir Obra">
                </form>
            </div>
        </div>
        <%}%>
